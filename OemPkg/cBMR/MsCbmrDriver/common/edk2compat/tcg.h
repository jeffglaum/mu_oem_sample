#ifndef _EDK2COMPAT_TCG_H_
#define _EDK2COMPAT_TCG_H_
...
//
// TCG PP definition of physical presence operation actions for storage
// management
//
...
#endif // _TCG_PHYSICAL_PRESENCE_H_
...
#define EFI_TCG2_PHYSICAL_PRESENCE_DATA_GUID              \
    {                                                     \
        0xaeb9c5c1, 0x94f1, 0x4d02,                       \
        {                                                 \
            0xbf, 0xd9, 0x46, 0x2, 0xdb, 0x2d, 0x3c, 0x54 \
        }                                                 \
    }
...
// operations. It should be protected from malicious software (e.g. Set it as
// read-only variable).
//
...
#endif // __TCG2_PHYSICAL_PRESENCE_DATA_GUID_H__

#endif // _EDK2COMPAT_TCG_H_
