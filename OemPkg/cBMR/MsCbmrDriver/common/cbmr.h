...
typedef EFI_STATUS(EFIAPI* EFI_MS_CBMR_PROGRESS_CALLBACK)(_In_ PEFI_MS_CBMR_PROTOCOL This,
                                                          _In_ EFI_MS_CBMR_PROGRESS* Progress);
...
typedef EFI_STATUS(EFIAPI* EFI_MS_CBMR_CONFIGURE)(_In_ PEFI_MS_CBMR_PROTOCOL This,
                                                  _In_ PEFI_MS_CBMR_CONFIG_DATA CbmrConfigData,
                                                  _In_opt_ EFI_MS_CBMR_PROGRESS_CALLBACK
                                                      ProgressCallback);
...
typedef EFI_STATUS(EFIAPI* EFI_MS_CBMR_GET_DATA)(_In_ PEFI_MS_CBMR_PROTOCOL This,
...
typedef EFI_STATUS(EFIAPI* EFI_MS_CBMR_START)(_In_ PEFI_MS_CBMR_PROTOCOL This);
...
typedef EFI_STATUS(EFIAPI* EFI_MS_CBMR_CLOSE)(_In_ PEFI_MS_CBMR_PROTOCOL This);
